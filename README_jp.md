...
1. **試合を記録する**
   ...
   **1.1 kifu.me Camera アプリを使う（推奨）**
   - スマートフォンアプリを使って、撮影からアップロードまでを簡単に行えます。
   - 詳しくは [kifu.me Camera マニュアル]({{ site.baseurl }}/APP_jp.html) をご覧ください。

   **1.2 アクションカメラ等で撮影した動画を[アップロード](https://kifu.me/upload)する**
   - 盤面が正しく映るように撮影してください。（詳細は[動画撮影](#動画撮影)の項目を参照）
   - アップロードできる動画のサイズは 16GB までです。
...
<img src="https://github.com/mkisono/kifume-support/blob/main/image/Screenshot%202026-08-31%20at%208.04.16.png?raw=true" alt="ダイスが赤く表示されている例" style="max-width: 100%; height: auto;">
...
- **ダイスの反射による誤認識**：ダイスの反射により、画像認識結果が誤った結果を出した
  ...
  - 11と13、22と26などを取り違えることがあります
    - これらは特に注意が必要なため、High importance records（重要度：高）として赤い背景で表示されます
...
以下の例では、青のプレイヤーがイリーガルムーブを行なったため、kifu.meは整合性のある指手を見つけることができませんでした。

<img src="https://github.com/mkisono/kifume-support/blob/main/image/Screenshot%202026-08-31%20at%208.05.59.png?raw=true" alt="ムーブが赤く表示されている例" style="max-width: 100%; height: auto;">
...
<p><strong>Q:</strong> 動画ファイルのサイズが 16GB 以上あるのでアップロードできません。</p>
